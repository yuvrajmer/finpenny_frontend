...
import { Check, ArrowRight, TrendingUp, Search, ShieldCheck } from 'lucide-react';
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -right-4 bg-primary-blue text-white p-8 rounded-2xl shadow-2xl min-w-[180px] text-center animate-bounce-subtle">
              <h2 className="text-5xl font-bold mb-2">
                {count}<span className="text-primary-red">+</span>
              </h2>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 text-[16px] leading-relaxed">
                FINPENNY is a trusted mutual fund distributor providing disciplined SIP planning, 
                tax-efficient investment solutions, and goal-based portfolio strategies for working 
